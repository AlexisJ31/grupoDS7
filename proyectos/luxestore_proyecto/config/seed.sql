...
(6, 3, 'Cinturón Reversible', 'Cuero genuino reversible negro/marrón', 75.00, NULL, 'cinturon-reversible.webp', NULL),
(7, 1, 'Trench Coat Camel', 'Gabardina clásica con detalles dorados', 320.00, 399.00, 'Trench Coat Camel.webp', 'Sale'),
...
(10, 1, 'Falda Plisada Midi', 'Plisado fino en satén mate', 95.00, NULL, 'Falda Plisada Midi.webp', 'Nuevo'),
(11, 2, 'Loafers Cuero Negro', 'Mocasines artesanales con borla', 210.00, NULL, 'loafers-negros.jpg', NULL),
(12, 3, 'Pañuelo Seda Estampado', 'Seda natural 90x90cm estampado exclusivo', 55.00, NULL, 'pañuelo.webp', 'Nuevo')
ON DUPLICATE KEY UPDATE nombre = VALUES(nombre), emoji = VALUES(emoji);
